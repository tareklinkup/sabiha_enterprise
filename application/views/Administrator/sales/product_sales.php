                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-12 col-lg-5">
                            <form v-on:submit.prevent="addToCart">
                                ...
                                <div class="form-group" style="display: none;"
                                    :style="{display: selectedProduct.is_serial == true ? '' : 'none'}">
                                    <label class="col-xs-3 control-label no-padding-right"> Serial </label>

                                    <div class="col-xs-7" style="padding-right:15px">
                                        <v-select v-if="!isProductFilterByBarcode" v-bind:options="serials"
                                            v-model="serial" label="ps_serial_number"></v-select>
                                        <input v-else type="text" v-model="barcodeValue" placeholder="Barcode"
                                            ref="barcode" class="form-control" id="barcode">
                                    </div>
                                    <div class="col-xs-1" style="padding: 0;">
                                        <a href="#" @click.prevent="changeProductFilter" class="btn btn-xs btn-danger"
                                            style="height: 26px; border: 0; width: 28px; margin-left: -12px;"
                                            target="_blank" title="Add New Product"><i class="fa fa-barcode"
                                                aria-hidden="true" style="margin-top: 5px;"></i></a>
                                    </div>
                                    <div class="col-xs-1" style="padding: 0;">
                                        <button type="button" id="show-modal" @click="serialShowModal"
                                            style="background: rgb(195 36 36 / 83%); color: white; border: none; font-size: 15px; height: 26px;width:28px; margin-left: -10px;margin-right:2px"><i
                                ...
                                <div class="form-group">
                                    <label class="col-xs-3 control-label no-padding-right"> Warranty
                            ...
                            <div class="table-responsive">
                                <table style="color:#000;margin-bottom: 0px;border-collapse: collapse;">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-xs-4">
                                                    <input type="number" id="discountPercent" class="form-control"
                                                        min="0" v-model="discountPercent" v-on:input="calculateTotal" />
                                                </div>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="form-group">
                                                <label class="col-xs-12 control-label no-padding-right">Service
                                                    Charge</label>
                                                <div class="col-xs-12">
                                                    <input type="number" class="form-control" min="0"
                                                        v-model="sales.serviceCharge" v-on:input="calculateTotal" />
                                                </div>
                                            </div>
                                        </td>
                                    </tr>
                                    ...
                                    <tr style="display: none;" :style="{display: sales.isPosSales == 1 ? '' : 'none'}">
                                        <td>
                                            <div class="form-group">
                                                <label class="col-xs-12 control-label no-padding-right">Retrun
                                                    Amount</label>
                                                <div class="col-xs-12">
                                                    <input type="number" id="returnAmount" class="form-control" min="0"
                                                        v-model="sales.returnAmount" v-on:input="calculateTotal"
                                                        readonly />
                                                </div>
                                            </div>
                                        </td>
                    ...
                    <div class="modal-container">
                                ...
                                <form @submit.prevent="addSerialNumber">
                                    <div class="form-group">
                                        ...
                                        <div class="col-xs-9" style="display: flex; margin-bottom: 5px;">
                                            <input type="text" autocomplete="off" ref="serialnumberadd"
                                                v-model="serialCart.range" class="form-control"
                                                placeholder="Please Enter Serial Number" style="height: 30px;"
                                                required />
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-xs-6">
                                            <input type="number" autocomplete="off" min="0"
                                                v-model="serialCart.quantity" class="form-control" required>
                                        </div>
                                        <div class="col-xs-2">
                                            <input type="submit" class="btn btn-xs primary"
                                                style="border: none; font-size: 13px; line-height: 0.38; background-color: #42b983 !important;height: 26px;width:76px;"
                                                value="Add">
                                        </div>
                                    </div>
                                </form>
                            ...
                            <table class="table">
                                ...
                                <tbody>
                                    ...
                                    <tr v-for="(product, sl) in sequences">
                                        ...
                                        <td @click="removeSerialItem(product.ps_serial_number)"> <span
                        ...
                        <div class="modal-footer">
                            <slot name="footer">
                                ...
                                <button class="modal-default-button" @click="serialHideModal"
                                    style="background: rgb(255, 255, 255);border: none;font-size: 18px;color: #de0000;margin-right: 6px;">
                                    Close
                                </button>
                            </slot>
                        </div>
    ...
    methods: {
        ...
        addToCart() {
            if (this.qId != 0) {
                ...
                if (parseInt(this.cart[getCurrentInd].quantity) == parseInt(this.cart[getCurrentInd].SerialStore
                        .length)) {
                ...
                if (this.selectedProduct.is_serial == true && product.SerialStore.length == 0 && this
                    .barcodeValue == '') {
                    alert('Select serial number. This product only serial availabe');
                    return;
                }

                if (this.serials.length && this.serial == null && this.sequences.length == 0 && this
                    .barcodeValue == '') {
                ...
                if (this.selectedProduct.is_serial == true && product.quantity > this.productStock && this.sales
                    .isService == 'false') {
                    ...
                    checkCart.map((item) => {
                        ...
                        if (storeObj.length && product.SerialStore.length) {
                            ...
                            if (checkSameI > -1) {
                                ...
                                this.cart[getCurrentInd].total = parseFloat(this.selectedProduct
                                    .total) + parseFloat(this.cart[getCurrentInd].total);
                            }
                        } else {
                            this.cart[getCurrentInd].quantity = this.selectedProduct.quantity;
                            this.cart[getCurrentInd].salesRate = this.selectedProduct
                                .Product_SellingPrice;
                            this.cart[getCurrentInd].total = parseFloat(product.salesRate * product
                                .quantity);
                        }
                    })
                } else {
        ...
        calculateTotal() {
            ...
            this.sales.serviceCharge = isNaN(this.sales.serviceCharge) || this.sales.serviceCharge == '' ? 0 :
                this.sales.serviceCharge;

            this.sales.total = ((parseFloat(this.sales.subTotal) + parseFloat(this.sales.vat) + parseFloat(this
                .sales.transportCost) + parseFloat(this.sales.serviceCharge)) - parseFloat(this.sales
                .discount)).toFixed(2);
            ...
            if (this.sales.paid != 0 && this.sales.isPosSales != 0) {
                this.sales.returnAmount = (parseFloat(this.sales.paid) - parseFloat(this.sales.total)).toFixed(
                    2)
                this.sales.due = 0;
            } else {
                ...
                if (r.success) {
                    ...
                    if (conf) {
                        ...
                        if (this.sales.isPosSales == 1) {
                            window.location = this.sales.isService == 'false' ? '/pos_sales' :
                                '/pos_sales';
                        } else {
