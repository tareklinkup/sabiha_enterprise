...
<div id="userAccess">
    ...
    <div class="row" id="accessRow">
        <div class="col-md-3">
            ...
            <div class="group">
                <input type="checkbox" id="deliveries" class="group-head" @click="onClickGroupHeads"> <strong>Delivery</strong>
                <ul ref="deliveries">
                    <li><input type="checkbox" class="access" value="delivery_entry" v-model="access"> Delivery Entry</li>
                    <li><input type="checkbox" class="access" value="delivery_record" v-model="access"> Delivery Record</li>
                </ul>
            </div>
        ...
        <div class="col-md-3">
            ...
            <!-- <div class="group">
                <input type="checkbox" id="hrPayroll" class="group-head" @click="onClickGroupHeads"> <strong>Repair</strong>
                <ul ref="hrPayroll">
                    <li><input type="checkbox" class="access" value="service" v-model="access"> Repair Entry</li>
                    <li><input type="checkbox" class="access" value="service_company" v-model="access"> Repair Company</li>
                    <li><input type="checkbox" class="access" value="expense" v-model="access"> Expense Entry</li>
                    <li><input type="checkbox" class="access" value="serviceRecord" v-model="access"> Repair Record</li>
                    <li><input type="checkbox" class="access" value="serviceStock" v-model="access"> Repair In Record</li>
                    <li><input type="checkbox" class="access" value="serviceOutStock" v-model="access"> Repair Out Record</li>
                </ul>
            </div> -->
        </div>
        <div class="col-md-3">
